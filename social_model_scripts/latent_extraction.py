...
# Data paths (set by pipeline from config; defaults for standalone)
...
latent_output_folder = '/path/to/latent_output/'
...
def main():
    ...
    model_path = f'{model_folder}best_model_relative_features_with_depth_{category_folder_name}_decoder_fixed_v4_enhanced_standardized_no_velocity_test_depth_output_seq{sequence_length}_latent{latent_dim}_bottleneck{bottleneck_dim}.h5'
    ...
    output_dir = f"{latent_output_folder}{category_folder_name}_latent_seq_{sequence_length}_latent_{latent_dim}_bottleneck_{bottleneck_dim}_no_velocity_test_depth/"
    print(f"Output directory: {output_dir}")
