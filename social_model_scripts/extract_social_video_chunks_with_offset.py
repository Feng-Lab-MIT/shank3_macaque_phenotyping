...
output_folder = '/path/to/video_chunks_output/'
video_folder = '/path/to/video_source/'
labels_file = '/path/to/labels.csv'
labels = pd.read_csv(labels_file, header=[0], dtype=str)
...
tsne_file = '/path/to/tsne_results.csv'
tsne_df = pd.read_csv(tsne_file)

stage_dic_path = '/path/to/stage_dic.pkl'
with open(stage_dic_path, 'rb') as f:
